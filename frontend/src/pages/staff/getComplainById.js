...
export const ComplaintByIdStaff = () => {
  ...
  const handleOtp = async () => {
    try {
      const response = await fetch(`https://student-management-server-jozx.onrender.com/staff/${id}/eComplaint/${complaintID}/otp`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
        }
  ...
  useEffect(() => {
    const fetchComplain = async () => {
      try {
        const response = await axios.get(`https://student-management-server-jozx.onrender.com/staff/${id}/eComplaint/${complaintID}`, {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
          }
