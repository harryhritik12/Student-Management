...
export function StudentSignup(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!isSentOtp) {
      ...
      await axios.post(`https://student-management-ssll.onrender.com/signup/student`, { firstName, lastName, email, password, rollNumber, branch, batch, graduationYear, program })
        .then(result => {
      ...
      await axios.post(`https://student-management-ssll.onrender.com/signup/authenticate`, { otp })
        .then(result => {
          console.log(result);
