...
export function StudentSignup(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!isSentOtp) {
      ...
      await axios.post(`${process.env.NODE_BACKEND_APP_BASE_URL}/signup/student`, { firstName, lastName, email, password, rollNumber, branch, batch, graduationYear, program })
        .then(result => {
