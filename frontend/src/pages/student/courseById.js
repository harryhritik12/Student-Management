...
export const CoursePage = () => {
    ...
    useEffect(() => {
        const fetchCourse = async () => {
            try {
                const response = await fetch(`${process.env.NODE_BACKEND_APP_BASE_URL}/student/${userId}/additionalCourse/${courseId}`, {
                    method: 'GET',
                    headers: {
                ...
                const userData = await fetch(`${process.env.NODE_BACKEND_APP_BASE_URL}/student/${userId}/profile`,{
                    method: 'GET',
                    headers: {
                        Authorization: `Bearer ${token}`,
                        'Content-Type': 'application/json',
    ...
    const handleOnClickRegister = async () => {
        try {
            const response = await fetch(`${process.env.NODE_BACKEND_APP_BASE_URL}/student/${userId}/additionalCourse/register/${course.courseID}`, {
                method: 'PATCH',
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    const handleOnClickUnregister = async () => {
        try {
            const response = await fetch(`${process.env.NODE_BACKEND_APP_BASE_URL}/student/${userId}/additionalCourse/unregister/${course.courseID}`, {
                method: 'PATCH',
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json',
