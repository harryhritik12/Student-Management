...
app.use(cors({
  origin: ['https://student-management-vdb9.vercel.app', 'http://localhost:3000'], // should match https://student-management-vdb9.vercel.app
...
app.options('*', (req, res) => {
  res.header('Access-Control-Allow-Origin', ['https://student-management-vdb9.vercel.app', 'http://localhost:3000'],);
